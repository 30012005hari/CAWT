...
\begin{figure}[H]
    \centering
    \begin{minipage}{0.18\columnwidth}\centering
    ...
    \begin{minipage}{0.18\columnwidth}\centering
        ...
        {\scriptsize (e) Unknown}
    \end{minipage}
    \caption{CardioScan classification output for each AAMI class showing predicted label, confidence, and ECG waveform.}
