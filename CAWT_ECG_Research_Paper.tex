...
The contrast between these two cases highlights an important property of the deployed model: even for the most challenging class in the dataset, the on-device inference produces a correct prediction with interpretable confidence scores. The 1.66~M parameter CAWT model runs with sub-second inference latency on commodity smartphone hardware, validating the feasibility of deploying the model in resource-constrained clinical and ambulatory settings.
